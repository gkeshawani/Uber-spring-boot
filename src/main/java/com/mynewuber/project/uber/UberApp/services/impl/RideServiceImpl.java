...
import com.mynewuber.project.uber.UberApp.repositories.RideRepository;
	...
	private final ModelMapper modelMapper;
	 ...
	 @Override
	    public Ride getRideById(Long rideId) {
	        ...
	        return rideRepository.findById(rideId).orElseThrow(() -> new ResourceNotFoundException("Ride not find with id:"+rideId));
	    }
